...
| **v0.23.0** | 🟢 phase A shipped | **Lazy-mode indexes — queries work.** Write-path maintenance ([#266](https://github.com/vLannaAi/noy-db/issues/266)): `put()`/`delete()` on a lazy collection with declared `indexes` now materialise `_idx/<field>/<recordId>` side-cars. Query dispatch ([#267](https://github.com/vLannaAi/noy-db/issues/267), [#268](https://github.com/vLannaAi/noy-db/issues/268)): `collection.lazyQuery().where(...).orderBy(...)` resolves candidate record ids through the in-memory mirror (bulk-loaded from side-cars on first query), decrypts only those. Unindexed-field reads throw `IndexRequiredError`. Rebuild/reconcile ([#269](https://github.com/vLannaAi/noy-db/issues/269)), benchmark harness ([#270](https://github.com/vLannaAi/noy-db/issues/270)), range predicates ([#275](https://github.com/vLannaAi/noy-db/issues/275)), composite indexes ([#276](https://github.com/vLannaAi/noy-db/issues/276)), FTS ([#277](https://github.com/vLannaAi/noy-db/issues/277)), auto-reconciler ([#278](https://github.com/vLannaAi/noy-db/issues/278)) remain open. |
