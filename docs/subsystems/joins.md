...
> **Subpath:** *(currently always-core; `@noy-db/hub/joins` extraction is a planned follow-up)*
...
- Partition-aware execution is plumbed but dormant — every `JoinLeg` carries `partitionScope: 'all'` today
