...
| `docs/architecture.md` | modify | Extend "Caching and lazy hydration" section with an `### Indexes in lazy mode` subsection + threat-model entry |
...
**Files:**
- Modify: `docs/architecture.md` (extend "Caching and lazy hydration" section; add threat-model row)
...
- [ ] **Step 5.1 — `docs/architecture.md`: add indexes subsection.**
...
```bash
git add docs/architecture.md CLAUDE.md SPEC.md
...
- Updates `docs/architecture.md`, `CLAUDE.md`, `SPEC.md`.
