/**
 * as-xlsx against the published `as-*` export-gate contract.
 *
...
import { toBytes, toBytesFromCollection, download, write } from '../src/index.js'
...
runFormatConformanceTests('as-xlsx', {
  ...
  exports: [
    ...
    { name: 'download', run: (vault) => download(vault, { sheets: [{ name: 'invoices', collection: 'invoices' }] }) },
