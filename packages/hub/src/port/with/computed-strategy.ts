 ...
 * descriptor's shape without a spine→`src/shape/**` static import (via-layering, Check 14).
 *
 ...
 * @internal
 */
import type { ComputedDescriptor } from '../../shape/via-computed/descriptor.js'
import { linkComputedVia } from '../../shape/via-computed/binding.js'
