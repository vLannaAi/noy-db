 ...
 * providers implement to seal/unseal a hub-generated random secret
 * for managed-secret mode. Its two methods (`seal`/`unseal`) close
 ...
 * managed-secret service), not the kernel spine proper — same
