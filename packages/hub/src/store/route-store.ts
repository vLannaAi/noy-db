...
/**
 * Options for `routeStore()` — the store multiplexer (v0.12 #162).
 *
...
/**
 * Named route that can be overridden or suspended at runtime (v0.12 #163).
 *
 ...
 * methods for overriding, suspending, and inspecting routes (v0.12 #163).
 */
