 ...
 * half of #87 constraint #2. When partition-aware aggregation
 ...
 * the executor**, plumbed through the protocol for #87 constraint
...
export interface ReducerOptions<TSeed = unknown> {
  /** #87 constraint #2 — seed is plumbed through but unused in. */
  readonly seed?: TSeed
}
