...
interface Invoice extends Record<string, unknown> { id: string; status: 'draft' | 'issued'; total: number; notes?: string }
interface Line extends Record<string, unknown> { id: string; invoiceId: string; amount: number }
