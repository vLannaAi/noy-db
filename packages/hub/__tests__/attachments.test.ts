...
describe('BlobSet (legacy attachment compat)', () => {
  ...
  it(
    'large blob is split into multiple chunks',
    // Extended timeout per #256. Encrypts ~3× default chunk-size
    // under AES-GCM; under parallel workspace runs (`pnpm turbo test`
    // ~49 workers share CPU) CPU contention pushes past the 5s
