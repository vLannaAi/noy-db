...
import * as inDoor from '../src/port/in/index.js'
import type { Noydb, Vault, Collection, Query, LiveQuery, ChangeEvent } from '../src/port/in/index.js'
...
const parsed = parseExports(read('../src/port/in/index.ts'))
